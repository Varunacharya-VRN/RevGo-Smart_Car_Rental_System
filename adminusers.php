...
<head>
    ...
    <title>User Management | RevGo Admin</title>
...
<style>
    ...
    text-decoration: none;
        ...
        .user-row:nth-child(5) { animation-delay: 0.5s; }
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="stats-container">
                ...
                <div class="stat-card">
                    ...
                    $maleQuery = "SELECT COUNT(*) as male_count FROM users WHERE GENDER='Male'";
                    $maleResult = mysqli_query($con, $maleQuery);
                    $maleCount = 0;
                    if ($maleResult) {
                ...
                <div class="stat-card">
                    ...
                    $femaleQuery = "SELECT COUNT(*) as female_count FROM users WHERE GENDER='Female'";
                    $femaleResult = mysqli_query($con, $femaleQuery);
                    $femaleCount = 0;
                    if ($femaleResult) {
                ...
                <div class="table-responsive">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr class="user-row">
                                <td data-label="Name" class="highlight"><?php echo $res['FNAME'] . ' ' . $res['LNAME']; ?></td>
                                <td data-label="Email"><?php echo $res['EMAIL']; ?></td>
                                <td data-label="License"><?php echo $res['LIC_NUM']; ?></td>
                                <td data-label="Phone"><?php echo $res['PHONE_NUMBER']; ?></td>
                                <td data-label="Gender"><?php echo $res['GENDER']; ?></td>
                                <td data-label="Actions">
                                    <a href="deleteuser.php?id=<?php echo $res['EMAIL']; ?>" class="action-btn btn-delete" onclick="return confirm('Are you sure you want to delete this user?')">
